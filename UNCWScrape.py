...
# import into CSV
rowList = ["Company Name", "Address","City", "State", "Zip", "Phone Number","Website"]
...
doc = BeautifulSoup(result.text, "html")
...
for directory in directories:
    ...
    for infobox in infoboxes:
        ...
        rowList = [company, street, city, state, zip, phone, website]
        with open("wilmington.csv", "a", newline='') as file:
            writer = csv.writer(file)
            writer.writerow(rowList)

        # print("Comany Name:", company, "Address:", street, ",", city, ",", state, zip, "Phone Number:", phone, "Website:", website)
